	...
	<div class="container">
		<div class="row offset-lg-1 text-center fondonegro p-4">
			<div class="col-12 text-center mb-4 ">
				<h1>Autores</h1>
				<h3 >Estos son los autores con los que contamos:</h3>
			</div>
			<div class="col-12 mx-auto ">
				<select class="form-select form-control-lg " style="height: 150px"
				  multiple aria-label="multiple select example">
  					...
  					<%
							...
							for (int i = 0; i < aux.size(); i++) {
								...
								out.println( aux.get(i).getAutor());
								out.println("</option>");
							}
				 ...
				 <div class="col-12 mt-5 text-center">
                   <a href="Principal.jsp" ><input href="Principal.jsp" class="hero-btn  me-5 pe-5 col-5" type="submit" value="Ventana Principal"></a>
