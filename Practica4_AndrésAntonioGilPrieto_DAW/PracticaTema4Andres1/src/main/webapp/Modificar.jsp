			...
			<div class="col-md-12 ">
				<div class="well well-sm ">
					<form class="form-horizontal" action="shopping" method="post">
						<fieldset>
							<legend><h2 class="text-center">Modificar</h2></legend>
							<input class="" type="hidden" name="todo" value="update">
							...
							<div class="form-group">
								<div class="col-md-12 text-center">
									<button type="submit" class="hero-btn btn-lg mt-3">Modificar</button>
								</div>
							</div>
						</fieldset>
					</form>
